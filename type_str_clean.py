...
a = a.replace("ul ","").replace("IES","ies")

# str: Jana III Sobieskiego
b = b.replace("\tul. ","").replace("trzeciego","III")
...
# str: Jana III Sobieskiego
e = d.title().replace("Ul. ","").replace("Iii","III")

# str: Jana III Sobieskiego
f = f.title().replace("Ulica ","").replace("Iii","III").rstrip()

# str: Jana III Sobieskiego
g = g.title().replace("Ulica. ","").replace("Iii","III")

# str: Jana III Sobieskiego
h = h.lstrip().rstrip().replace("3","III")
