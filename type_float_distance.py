...
meters = f'Meters: {round(distance,0)}'

# str: distance in kilometers with 0 decimal places
kilometers = f'Kilometers: {int(round(distance_km,0))}'

# str: distance in miles with 2 decimal places
miles = f'Miles: {round(distance_mi,2)}'

# str: distance in nautical miles with 3 decimal places
nautical_miles = f'Nautical Miles: {round(distance_NM,3)}'

# str: distance in km, mi, NM with 0, 1, 2 decimal places
all_units = (f'km: {int(round(distance_km,0))}, '
             f'mi: {round(distance_mi,1)}, '
             f'NM: {round(distance_NM,2)}')
