...
#result = frozenset({"We choose to go to the Moon","in this decade and do the other things.","Not because they are easy, but because they are hard."})

#result = frozenset(DATA.splitlines())

result = frozenset(DATA.split("\n"))